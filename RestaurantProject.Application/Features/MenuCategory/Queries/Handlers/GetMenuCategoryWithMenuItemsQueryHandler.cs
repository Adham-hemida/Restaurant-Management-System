...
public class GetMenuCategoryWithMenuItemsQueryHandler(IMenuCategoryService menuCategoryService) : IRequestHandler<GetMenuCategoryWithMenuItemsQuery, Result<MenuCategoryWithMenuItemsResponse>>
{
